...
module.exports = (function() {
	...
	Connection.prototype.loginStateMachine = function loginStateMachine() {
		...
		lc.write('/login', { "=name" : _(this).user, "=password" : _(this).password }); _(this).status = 'Waiting for Response';
		...
		lc.on('done', function loginDone(data) {
			...
			case 'Waiting for challenge':
				...
				challenge.write(parsed[0].String, _(_this).password.length + 1, 'hex');
